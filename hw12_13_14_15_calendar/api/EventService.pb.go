...
var file_EventService_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x32, 0xa2, 0x03,
...
var file_EventService_proto_depIdxs = []int32{
	...
	2, // 10: event.EventService.DeleteEvent:output_type -> event.Response
	4, // 11: event.EventService.GetDailyEvents:output_type -> event.GetEventsResponse
	4, // 12: event.EventService.GetWeeklyEvents:output_type -> event.GetEventsResponse
	4, // 13: event.EventService.GetMonthlyEvents:output_type -> event.GetEventsResponse
	4, // 14: event.EventService.GetNotificationEvents:output_type -> event.GetEventsResponse
